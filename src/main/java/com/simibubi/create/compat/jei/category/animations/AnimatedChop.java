...
public class AnimatedChop extends AnimatedKinetics {

	private boolean basin;

	public AnimatedChop(boolean basin) {
		this.basin = basin;
	}
	...
	public void draw(MatrixStack matrixStack, int xOffset, int yOffset) {
		...
		GuiGameElement.of(AllBlocks.MECHANICAL_CHOP.getDefaultState())
				.scale(scale)
				.render(matrixStack);

		GuiGameElement.of(AllBlockPartials.MECHANICAL_CHOP_HEAD)
